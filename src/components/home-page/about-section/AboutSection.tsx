    ...
    <div id="about" className={`w-full ${styles.container}`}>
      <div className={`relative w-full flex flex-row`}>
        ...
        >
          ...
          <div className="whitespace-pre-line flex flex-col gap-5 text-sm sm:text-md md:text-xl mb-2 ml-5 mr-5 sm:mr-0 sm:ml-12.5 md:ml-0">
            {lang == "Viet"
          ...
          <div className="relative">
            ...
            />
            <div className="whitespace-pre-line flex flex-col gap-5 md:mb-5 text-sm sm:text-md md:text-xl mb-2 ml-5 mr-5 sm:mr-0 sm:ml-12.5 md:ml-0 text-justify">
              {lang == "Viet"
            ...
            <div className="whitespace-pre-line flex flex-col gap-5 text-sm sm:text-md md:text-xl mb-5 md:mb-0 ml-5 mr-5 sm:mr-0 sm:ml-12.5 md:ml-0 text-justify">
              {lang == "Viet"
